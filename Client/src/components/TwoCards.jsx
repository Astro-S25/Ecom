...
const TwoCards = (props) => {
  ...
  <figure><img src={props.image1} alt={props.alt1} className="rounded-xl h-52 "/></figure>
...
<figure><img src={props.image2} alt={props.alt2} className="rounded-xl h-52  "/></figure>
<div className="card-body">
