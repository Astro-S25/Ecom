...
import {Header ,Slider ,Tiles ,Footer ,TwoCards ,TwoCenterCards ,HomeData} from '../components'
...
function StoreHome() {
  ...
  <Slider image1={data.image1} image2={data.image2} image3={data.image3} image4={data.image4}
   alt1={data.alt1} alt2={data.alt2} alt3={data.alt3} alt4={data.alt4} key={data.id}/> )
  }
  ...
  {HomeData.twoCardsData.map (data=><TwoCards image1={data.image1} image2={data.image2} alt1={data.alt1} alt2={data.alt2} 
   title1={data.title1} title2={data.title2} p1={data.p1} p2={data.p2} key={data.id}/>)}  
  ...
  <Tiles text1={"TVs"} text2={"Headphones"} text3={"Mobiles"} text4={"Laptops"} text5={"Explore all"}
          button1={"TVs"} button2={"Headphones"} button3={"Mobiles"} button4={"Laptops"} button5={"Explore all"}/>

  <div className="w-auto h-1  bg-amber-500  mb-24 "></div>
  {HomeData.twoCenterCardsData.map(data=> <TwoCenterCards image1={data.image1} image2={data.image2}   alt1={data.alt1} alt2={data.alt2}
   title1={data.title1} title2={data.title2} strike1={data.strike1} strike2={data.strike2} p1={data.p1} p2={data.p2} key={data.id}/>)}
